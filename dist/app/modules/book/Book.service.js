...
const getAllFromDb = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { searchTerm, minPrice, maxPrice } = filters, filterData = __rest(filters, ["searchTerm", "minPrice", "maxPrice"]); // Added minPrice and maxPrice
    const andConditions = [];
    if (searchTerm) {
        andConditions.push({
...
const getByCategoryId = (id, options) => __awaiter(void 0, void 0, void 0, function* () {
    const { limit, page, skip } = paginationHelper_1.paginationHelpers.calculatePagination(options);
    const result = yield prisma_1.default.book.findMany({
        where: {
            categoryId: id,
